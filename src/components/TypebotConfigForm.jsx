...
const TypebotConfigForm = ({
	...
	return (
		<div className="max-w-3xl mx-auto bg-whatsapp-profundo rounded-xl shadow-lg p-6">
			<ActionButtons />
				...
				<div className="mt-8 flex justify-between">
					...
					{currentStep < steps.length ? (
						<button
							...
							className="px-6 py-2 rounded-lg bg-whatsapp-green text-white hover:bg-whatsapp-green/90"
						>
							Próximo
						</button>
					) : (
						<button
							...
							disabled={isSaving}
							className="px-6 py-2 rounded-lg bg-whatsapp-green text-white hover:bg-whatsapp-green/90 disabled:opacity-50"
						>

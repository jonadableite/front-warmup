	...
	return (
		<div className="max-w-3xl mx-auto bg-whatsapp-dark/10 rounded-xl shadow-lg p-6">
			...
			<div className="flex justify-between mb-8 relative">
				<div className="absolute top-5 left-0 right-0 h-0.5 bg-whatsapp-green -z-10" />
				{steps.map((step, idx) => (
					<StepIndicator
						key={step.id}
						step={step}
				...
				<div className="mt-8 flex justify-between">
					...
					{currentStep < steps.length ? (
						<button
							...
							className="px-6 py-2 rounded-lg bg-whatsapp-green text-white hover:bg-whatsapp-green/50"
						>
							Próximo
						</button>
					) : (
						<button
							...
							disabled={isSaving}
							className="px-6 py-2 rounded-lg bg-whatsapp-green text-white hover:bg-whatsapp-green/50 disabled:opacity-50"
						>

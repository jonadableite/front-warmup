        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="mt-1 block w-full rounded-md border-gray-600 bg-whatsapp-profundo text-white placeholder-gray-400 shadow-sm focus:border-whatsapp-green focus:ring-whatsapp-green"
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="mt-1 block w-full rounded-md border-gray-600 bg-whatsapp-profundo text-white shadow-sm focus:border-whatsapp-green focus:ring-whatsapp-green"
            />
          </div>
          <div className="mb-4">
            <label className="block text-sm font-medium text-white">

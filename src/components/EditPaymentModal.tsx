...
const EditPaymentModal: React.FC<EditPaymentModalProps> = ({
	...
	return (
		...
		>
			<motion.div
				className="bg-profundo/80 p-6 rounded-lg shadow-lg w-96"
				initial={{ scale: 0.8 }}
				animate={{ scale: 1 }}
				...
				<form onSubmit={handleSubmit}>
					<div className="mb-4">
						...
						<input
							...
							className="mt-1 block w-full rounded-md border-gray-600 bg-profundo/60 text-white shadow-sm focus:border-whatsapp-green focus:ring-whatsapp-green"
						/>
					</div>
					<div className="mb-4">
						<label className="block text-sm font-medium text-white">

...
const SidebarComponent: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTrialInfo = () => {
      try {
        ...
        console.error(
          'Erro ao buscar informações do período de teste:',
          error,
        );
        setTrialDaysLeft(null);
      }
  ...
  const allowedEmails = [
    'jonadab.leite@gmail.com',
    'lucaslopes0108@gmail.com',
  ];
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-4 border-t border-gray-800/50">
          <div className="mb-4 flex flex-col items-center">
            ...
            >
              Desbloqueie todos os recursos e tenha acesso ilimitado à
              nossa plataforma
            </motion.p>
          </div>
        ...
        <div className="p-4 border-t border-gray-800/50">
          ...
          >
            ...
            <DropdownMenuItem
              onClick={() =>
                window.open(
                  'mailto:suporte@whatlead.com.br',
                  '_blank',
                )
              }
            >
